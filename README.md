...
![Location](https://img.shields.io/badge/📍-Greater_Toronto_Area-2A3B52?style=flat)
...
M.Eng in Electrical & Computer Engineering (TMU) · B.Eng in Computer Engineering (McMaster)  
Interested in full-stack systems, embedded firmware, and digital design.  
...
![Verilog](https://img.shields.io/badge/Verilog-FF6B35?style=flat)
![SystemVerilog](https://img.shields.io/badge/SystemVerilog-FF6B35?style=flat)
![FPGA](https://img.shields.io/badge/FPGA-6C3483?style=flat)
![ASIC](https://img.shields.io/badge/ASIC-6C3483?style=flat)
![MSP432](https://img.shields.io/badge/MSP432-E74C3C?style=flat)
![Raspberry Pi](https://img.shields.io/badge/Raspberry_Pi-C51A4A?style=flat&logo=raspberrypi&logoColor=white)
![Arduino](https://img.shields.io/badge/Arduino-00979D?style=flat&logo=arduino&logoColor=white)
![I²C/UART](https://img.shields.io/badge/I²C_/_UART-555?style=flat)
...
![CuPy](https://img.shields.io/badge/CuPy-76B900?style=flat)
...
### 🎵 SoundTown
Full-stack music player with a Django backend and vanilla JS frontend.  
`Django` `JavaScript` `PostgreSQL`

---

### 🔒 BlueLock
Android app + Raspberry Pi firmware for Bluetooth-based door access, with Firebase authentication.  
`Android` `Firebase` `Raspberry Pi` `BLE`
...
`Python` `CuPy` `NumPy` `IEEE`

---

⭐ *GitHub is where I experiment, learn, and build full-stack systems — from bare metal to the browser.*
